package de.minetrouble.networkapi.manager.color;

import com.google.common.collect.ImmutableMap;
import de.minetrouble.networkapi.manager.color.pattern.GradientPattern;
import de.minetrouble.networkapi.manager.color.pattern.IPattern;
import de.minetrouble.networkapi.manager.color.pattern.RainbowPattern;
import de.minetrouble.networkapi.manager.color.pattern.SolidPattern;
...
public class ColorBuilder {
    ...
    public static List<String> process(@NotNull List<String> strings) {
        return strings.stream().map(ColorBuilder::process).collect(Collectors.toList());
    }
