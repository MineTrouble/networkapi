...
import de.minetrouble.networkapi.command.coins.CoinAdminCommand;
...
import de.minetrouble.networkapi.manager.discord.WebHookConfig;
...
import de.minetrouble.networkapi.manager.stats.StatsPlayer;
import de.minetrouble.networkapi.manager.stats.StatsPlayerCache;
...
public class NetworkApi extends JavaPlugin {
    ...
    @Getter private StatsPlayer statsPlayer;
    @Getter private NetworkPlayerCache networkPlayerCache;
    @Getter private StatsPlayerCache statsPlayerCache;
    ...
    @Getter private WebHookConfig webHookConfig;
    @Getter private ChatPrefix chatPrefix;
